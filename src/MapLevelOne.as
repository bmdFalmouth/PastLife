...
package  {
	...
	public class MapLevelOne extends MapBase {
		//Media content declarations
		[Embed(source="../assets/MapCSV_LevelOne_MainGame.txt", mimeType="application/octet-stream")] public var CSV_MainGame:Class;
		[Embed(source="../assets/game_tilesheetA32wide.png")] public var Img_MainGame:Class;

		
		public function MapLevelOne() {
			treesAllowed = 0;
			platformsAllowed = 4;
			explosionsAllowed = 0;
		...
		override public function addSpritesToLayerMainGame(onAddCallback:Function = null):void {
			...
			obj = new Player(210, 186);;
			obj.x+=obj.offset.x;
			obj.y+=obj.offset.y;
			FlxG.state.add(obj);
			if(onAddCallback != null)
				onAddCallback(obj);
			obj = new CreateTutorialTrigger(346, 176);;
			obj.x+=obj.offset.x;
			obj.y+=obj.offset.y;
			FlxG.state.add(obj);
			if(onAddCallback != null)
				onAddCallback(obj);
			obj = new Exit(769, 226);;
			obj.x+=obj.offset.x;
			obj.y+=obj.offset.y;
			FlxG.state.add(obj);
			if(onAddCallback != null)
