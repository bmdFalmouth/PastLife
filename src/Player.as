package
{
	...
	public class Player extends FlxSprite
	{
		...
		{	
			...
			//TODO: What did the last param do for playing sounds?
			//footstep.loadEmbedded(footstepSound, true, true);
			footstep.loadEmbedded(footstepSound, true);
		...
		override public function update():void
		{
			...
			//You have to call this at the end of every update function, this
			//allows the underlying engine to update itself and carry out the simulation
			super.update();
		...
		public function explode(diameter:int):void
		{
			...
			{
				_gibs.at(this);
				//TODO: Particle emition has changed, what are the 2nd and 3rd Param? - BMD
